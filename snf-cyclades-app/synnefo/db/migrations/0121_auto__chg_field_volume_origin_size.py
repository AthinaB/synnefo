...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Volume.origin_size'
        db.alter_column('db_volume', 'origin_size', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Volume.origin_size'
        db.alter_column('db_volume', 'origin_size', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'db.volume': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'legacy_backend_volume_uuid': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
            ...
            'origin_size': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
            'project': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'db_index': 'True'}),
